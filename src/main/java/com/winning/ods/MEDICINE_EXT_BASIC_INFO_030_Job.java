...
import com.winning.sink.MEDICINE_EXT_BASIC_INFO_030_Sink;
import com.winning.sink.MEDICINE_PACKING_UNIT_020_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_EXT_BASIC_INFO_030_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_EXT_BASIC_INFO")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_EXT_BASIC_INFO_030_Sink()).name("Sink_030");
        //触发执行
        env.execute("MEDICINE_EXT_BASIC_INFO_030_Job");
    }
}
