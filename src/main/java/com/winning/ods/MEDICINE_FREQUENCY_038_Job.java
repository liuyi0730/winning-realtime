...
import com.winning.sink.MEDICINE_FREQUENCY_038_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_FREQUENCY_038_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_FREQUENCY")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_FREQUENCY_038_Sink()).name("Sink_038");
        //触发执行
        env.execute("MEDICINE_FREQUENCY_038_Job");
    }
}
