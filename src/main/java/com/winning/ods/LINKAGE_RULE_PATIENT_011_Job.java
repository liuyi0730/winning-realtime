...
import com.winning.sink.LINKAGE_RULE_PATIENT_011_Sink;
 ...
 * @Version 1.0
 */
public class LINKAGE_RULE_PATIENT_011_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".LINKAGE_RULE_PATIENT")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new LINKAGE_RULE_PATIENT_011_Sink()).name("Sink_011");
        //触发执行
        env.execute("LINKAGE_RULE_PATIENT_011_Job");
    }
}
