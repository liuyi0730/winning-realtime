...
import com.winning.sink.CLINICAL_SERVICE_ADT_072_Sink;
 ...
 * @Version 1.0
 */
public class CLINICAL_SERVICE_ADT_072_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".CLINICAL_SERVICE_ADT")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new CLINICAL_SERVICE_ADT_072_Sink()).name("Sink_072");
        //触发执行
        env.execute("CLINICAL_SERVICE_ADT_072_Job");
    }
}
