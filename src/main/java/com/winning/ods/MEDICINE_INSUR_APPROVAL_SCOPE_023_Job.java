...
import com.winning.sink.MEDICINE_ALIAS_021_Sink;
import com.winning.sink.MEDICINE_INSUR_APPROVAL_SCOPE_023_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_INSUR_APPROVAL_SCOPE_023_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_INSUR_APPROVAL_SCOPE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_INSUR_APPROVAL_SCOPE_023_Sink()).name("Sink_023");
        //触发执行
        env.execute("MEDICINE_INSUR_APPROVAL_SCOPE_023_Job");
    }
}
