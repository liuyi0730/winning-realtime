 ...
 * @Version 1.0
 */
public class MEDICINE_PACKING_UNIT_020_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_PACKING_UNIT")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_PACKING_UNIT_020_Sink()).name("Sink_020");
        //触发执行
        env.execute("MEDICINE_PACKING_UNIT_020_Job");
    }
}
