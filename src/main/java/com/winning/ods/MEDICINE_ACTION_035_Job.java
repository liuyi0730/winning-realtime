...
import com.winning.sink.MEDICINE_ACTION_035_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_ACTION_035_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_ACTION")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_ACTION_035_Sink()).name("Sink_035");
        //触发执行
        env.execute("MEDICINE_ACTION_035_Job");
    }
}
