...
import com.winning.sink.LINKAGE_RULE_012_Sink;
 ...
 * @Version 1.0
 */
public class LINKAGE_RULE_012_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".LINKAGE_RULE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new LINKAGE_RULE_012_Sink()).name("Sink_012");
        //触发执行
        env.execute("LINKAGE_RULE_012_Job");
    }
}
