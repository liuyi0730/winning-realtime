 ...
 * @Version 1.0
 */
public class MEDICINE_INSUR_PAYMENT_022_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_INSUR_PAYMENT")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new com.winning.ods.MEDICINE_INSUR_PAYMENT_022_Sink()).name("Sink_022");
        //触发执行
        env.execute("MEDICINE_INSUR_PAYMENT_022_Job");
    }
}
