...
import com.winning.sink.MEDICINE_MGT_CLASSIFICATION_044_Sink;
import com.winning.sink.ORGANIZATION_CLINICAL_SERVICE_050_Sink;
 ...
 * @Version 1.0
 */
public class ORGANIZATION_CLINICAL_SERVICE_050_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".ORGANIZATION_CLINICAL_SERVICE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new ORGANIZATION_CLINICAL_SERVICE_050_Sink()).name("Sink_050");
        //触发执行
        env.execute("ORGANIZATION_CLINICAL_SERVICE_050_Job");
    }
}
