 ...
 * @Version 1.0
 */
public class LABTEST_SPECIMEN_058_Sink extends TwoPhaseCommitSinkFunction<Tuple1<String>, HikariUtil, Void> { //表名替换
    private static final Logger log = LoggerFactory.getLogger(LABTEST_SPECIMEN_058_Sink.class);//表名替换

    public LABTEST_SPECIMEN_058_Sink() {//表名替换
    ...
    protected void invoke(HikariUtil HikariUtil, Tuple1<String> tuple, Context context) throws Exception {
        ...
        //主键设置，可能是多个字段组合成主键
		//------------begin---添加字段-----------
        String KeyID_01 = jsonObject.getString("LABTEST_SPECI_ID"); //
        String KeyID_02 = jsonObject.getString("HOSPITAL_SOID"); //
        String upd_sql = "update labtest_specimen set end_time=? " +    //
                "where LABTEST_SPECI_ID =? and HOSPITAL_SOID =? and end_time='3000-12-31 00:00:00' "; //
        ...
        String insert_sql = "insert into labtest_specimen " +
                "(LABTEST_SPECI_ID,CS_ID,SPECI_CODE,SPECI_TYPE_CODE,SPECI_DESC,CONTAINER_TYPE_CODE,LABTEST_GROUP_CODE,COLLECTION_METHOD_CODE,COLLECTION_METHOD_NOTES,HOSPITAL_SOID,IS_DEL,CREATED_AT,MODIFIED_AT,start_time,physical_delete) " +
                "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";//改为表的字段总数-1
        ...
        insert_ps.setString(3, jsonObject.getString("SPECI_CODE"));
        insert_ps.setString(4, jsonObject.getString("SPECI_TYPE_CODE"));
        insert_ps.setString(5, jsonObject.getString("SPECI_DESC"));
        insert_ps.setString(6, jsonObject.getString("CONTAINER_TYPE_CODE"));
        insert_ps.setString(7, jsonObject.getString("LABTEST_GROUP_CODE"));
        insert_ps.setString(8, jsonObject.getString("COLLECTION_METHOD_CODE"));
        insert_ps.setString(9, jsonObject.getString("COLLECTION_METHOD_NOTES"));
