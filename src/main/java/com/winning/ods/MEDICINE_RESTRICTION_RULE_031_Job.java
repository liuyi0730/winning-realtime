 ...
 * @Version 1.0
 */
public class MEDICINE_RESTRICTION_RULE_031_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_RESTRICTION_RULE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_RESTRICTION_RULE_031_Sink()).name("Sink_031");
        //触发执行
        env.execute("MEDICINE_RESTRICTION_RULE_031_Job");
    }
}
