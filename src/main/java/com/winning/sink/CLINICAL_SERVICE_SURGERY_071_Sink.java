 ...
 * @Version 1.0
 */
public class CLINICAL_SERVICE_SURGERY_071_Sink extends TwoPhaseCommitSinkFunction<Tuple1<String>, HikariUtil, Void> { //表名替换
    private static final Logger log = LoggerFactory.getLogger(CLINICAL_SERVICE_SURGERY_071_Sink.class);//表名替换

    public CLINICAL_SERVICE_SURGERY_071_Sink() {//表名替换
    ...
    protected void invoke(HikariUtil HikariUtil, Tuple1<String> tuple, Context context) throws Exception {
        ...
        String upd_sql = "update clinical_service_surgery set end_time=? " +    //
        ...
        String insert_sql = "insert into clinical_service_surgery " +
                "(CS_ID,SURGERY_LEVEL_CODE,ICD9_CM3_CODE,SURGICAL_INCISION_LEVEL_CODE,SURGERY_TYPE_CODE,HOSPITAL_SOID,IS_DEL,CREATED_AT,MODIFIED_AT,SURGERY_ID,INCISION_ATTR_CODE,start_time,physical_delete) " +
                "values (?,?,?,?,?,?,?,?,?,?,?,?,?)";//改为表的字段总数-1
        ...
        insert_ps.setString(2, jsonObject.getString("SURGERY_LEVEL_CODE"));
        insert_ps.setString(3, jsonObject.getString("ICD9_CM3_CODE"));
        insert_ps.setString(4, jsonObject.getString("SURGICAL_INCISION_LEVEL_CODE"));
        insert_ps.setString(5, jsonObject.getString("SURGERY_TYPE_CODE"));
        ...
        insert_ps.setString(10, jsonObject.getString("SURGERY_ID"));
        insert_ps.setString(11, jsonObject.getString("INCISION_ATTR_CODE"));
