...
import com.winning.sink.CLINICAL_ORDER_FLOW_RULE_001_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_ALIAS_021_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_ALIAS")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_ALIAS_021_Sink()).name("Sink_021");
        //触发执行
        env.execute("MEDICINE_ALIAS_021_Job");
    }
}
