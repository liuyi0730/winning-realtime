...
import com.winning.sink.MED_SERVICE_BINDING_STATUS_033_Sink;
 ...
 * @Version 1.0
 */
public class MED_SERVICE_BINDING_STATUS_033_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MED_SERVICE_BINDING_STATUS")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MED_SERVICE_BINDING_STATUS_033_Sink()).name("Sink_033");
        //触发执行
        env.execute("MED_SERVICE_BINDING_STATUS_033_Job");
    }
}
