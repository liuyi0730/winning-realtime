...
import com.winning.sink.CLI_ORDER_FLOW_EXTENDED_TIME_004_Sink;
 ...
 * @Version 1.0
 */
public class CLI_ORDER_FLOW_EXTENDED_TIME_004_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".CLI_ORDER_FLOW_EXTENDED_TIME")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new CLI_ORDER_FLOW_EXTENDED_TIME_004_Sink()).name("Sink_004");
        //触发执行
        env.execute("CLI_ORDER_FLOW_EXTENDED_TIME_004_Job");
    }
}
