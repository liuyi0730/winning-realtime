...
import com.winning.sink.MEDICINE_RECOMMENDED_DOSAGE_040_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_MGT_CLASSIFICATION_044_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_MGT_CLASSIFICATION")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_MGT_CLASSIFICATION_044_Sink()).name("Sink_044");
        //触发执行
        env.execute("MEDICINE_MGT_CLASSIFICATION_044_Job");
    }
}
