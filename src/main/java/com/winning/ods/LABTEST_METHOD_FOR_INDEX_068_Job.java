...
import com.winning.sink.LABTEST_METHOD_FOR_INDEX_068_Sink;
 ...
 * @Version 1.0
 */
public class LABTEST_METHOD_FOR_INDEX_068_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".LABTEST_METHOD_FOR_INDEX")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new LABTEST_METHOD_FOR_INDEX_068_Sink()).name("Sink_068");
        //触发执行
        env.execute("LABTEST_METHOD_FOR_INDEX_068_Job");
    }
}
