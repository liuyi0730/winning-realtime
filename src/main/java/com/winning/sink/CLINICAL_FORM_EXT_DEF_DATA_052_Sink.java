 ...
 * @Version 1.0
 */
public class CLINICAL_FORM_EXT_DEF_DATA_052_Sink extends TwoPhaseCommitSinkFunction<Tuple1<String>, HikariUtil, Void> { //表名替换
    private static final Logger log = LoggerFactory.getLogger(CLINICAL_FORM_EXT_DEF_DATA_052_Sink.class);//表名替换

    public CLINICAL_FORM_EXT_DEF_DATA_052_Sink() {//表名替换
    ...
    protected void invoke(HikariUtil HikariUtil, Tuple1<String> tuple, Context context) throws Exception {
        ...
        //主键设置，可能是多个字段组合成主键
		//------------begin---添加字段-----------
        String KeyID_01 = jsonObject.getString("CLI_FORM_EXT_DEF_DATA_ID"); //
        String KeyID_02 = jsonObject.getString("HOSPITAL_SOID"); //
        String upd_sql = "update clinical_form_ext_def_data set end_time=? " +    //
                "where CLI_FORM_EXT_DEF_DATA_ID =? and HOSPITAL_SOID =? and end_time='3000-12-31 00:00:00' "; //
        ...
        String insert_sql = "insert into clinical_form_ext_def_data " +
                "(CLI_FORM_EXT_DEF_DATA_ID,CS_ID,CLI_FORM_EXT_DEF_DATA_BLOCK,ENABLED_FLAG,HOSPITAL_SOID,IS_DEL,CREATED_AT,MODIFIED_AT,start_time,physical_delete) " +
                "values (?,?,?,?,?,?,?,?,?,?)";//改为表的字段总数-1
        ...
        insert_ps.setString(3, jsonObject.getString("CLI_FORM_EXT_DEF_DATA_BLOCK"));
        insert_ps.setString(4, jsonObject.getString("ENABLED_FLAG"));
        ...
        insert_ps.setTimestamp(8, jsonObject.getTimestamp("MODIFIED_AT"));
