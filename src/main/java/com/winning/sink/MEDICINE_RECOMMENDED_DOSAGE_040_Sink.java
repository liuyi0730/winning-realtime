 ...
 * @Version 1.0
 */
public class MEDICINE_RECOMMENDED_DOSAGE_040_Sink extends TwoPhaseCommitSinkFunction<Tuple1<String>, HikariUtil, Void> { //表名替换
    private static final Logger log = LoggerFactory.getLogger(MEDICINE_RECOMMENDED_DOSAGE_040_Sink.class);//表名替换

    public MEDICINE_RECOMMENDED_DOSAGE_040_Sink() {//表名替换
    ...
    protected void invoke(HikariUtil HikariUtil, Tuple1<String> tuple, Context context) throws Exception {
        ...
        //主键设置，可能是多个字段组合成主键
		//------------begin---添加字段-----------
        String KeyID_01 = jsonObject.getString("MEDICINE_RECOMMENDED_DOSAGE_ID"); //
        String KeyID_02 = jsonObject.getString("HOSPITAL_SOID"); //
        String upd_sql = "update medicine_recommended_dosage set end_time=? " +    //
                "where MEDICINE_RECOMMENDED_DOSAGE_ID =? and HOSPITAL_SOID =? and end_time='3000-12-31 00:00:00' "; //
        ...
        String insert_sql = "insert into medicine_recommended_dosage " +
                "(MEDICINE_RECOMMENDED_DOSAGE_ID,MEDICINE_ID,ENCOUNTER_TYPE_CODE,SEQ_NO,RCMDD_DOSAGE,RCMDD_DOSAGE_UNIT_CODE,RCMDD_DOSAGE_CONV_FACTOR,RCMDD_QTY,RCMDD_FREQ_CODE,RCMDD_DOSAGE_ROUTE_TYPE_CODE,RCMDD_USE_DAYS,ENABLED_FLAG,HOSPITAL_SOID,IS_DEL,CREATED_AT,MODIFIED_AT,start_time,physical_delete) " +
                "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";//改为表的字段总数-1
        ...
        insert_ps.setString(3, jsonObject.getString("ENCOUNTER_TYPE_CODE"));
        insert_ps.setString(4, jsonObject.getString("SEQ_NO"));
        insert_ps.setString(5, jsonObject.getString("RCMDD_DOSAGE"));
        insert_ps.setString(6, jsonObject.getString("RCMDD_DOSAGE_UNIT_CODE"));
        insert_ps.setString(7, jsonObject.getString("RCMDD_DOSAGE_CONV_FACTOR"));
        insert_ps.setString(8, jsonObject.getString("RCMDD_QTY"));
        insert_ps.setString(9, jsonObject.getString("RCMDD_FREQ_CODE"));
        insert_ps.setString(10, jsonObject.getString("RCMDD_DOSAGE_ROUTE_TYPE_CODE"));
        insert_ps.setString(11, jsonObject.getString("RCMDD_USE_DAYS"));
        insert_ps.setString(12, jsonObject.getString("ENABLED_FLAG"));
        insert_ps.setString(13, KeyID_02);
        insert_ps.setString(14, jsonObject.getString("IS_DEL"));
        insert_ps.setTimestamp(15, jsonObject.getTimestamp("CREATED_AT"));
        insert_ps.setTimestamp(16, jsonObject.getTimestamp("MODIFIED_AT"));
