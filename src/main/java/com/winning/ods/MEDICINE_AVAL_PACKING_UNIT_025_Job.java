...
import com.winning.sink.MEDICINE_AVAL_PACKING_UNIT_025_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_AVAL_PACKING_UNIT_025_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_AVAL_PACKING_UNIT")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_AVAL_PACKING_UNIT_025_Sink()).name("Sink_025");
        //触发执行
        env.execute("MEDICINE_AVAL_PACKING_UNIT_025_Job");
    }
}
