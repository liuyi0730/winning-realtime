...
import com.winning.sink.CLINICAL_SERVICE_ALIAS_063_Sink;
import com.winning.sink.CLINICAL_SERVICE_INSTRUCTION_073_Sink;
 ...
 * @Version 1.0
 */
public class CLINICAL_SERVICE_INSTRUCTION_073_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".CLINICAL_SERVICE_INSTRUCTION")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new CLINICAL_SERVICE_INSTRUCTION_073_Sink()).name("Sink_073");
        //触发执行
        env.execute("CLINICAL_SERVICE_INSTRUCTION_073_Job");
    }
}
