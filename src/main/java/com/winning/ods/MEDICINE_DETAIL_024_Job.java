...
import com.winning.sink.MEDICINE_DETAIL_024_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_DETAIL_024_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_DETAIL")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_DETAIL_024_Sink()).name("Sink_024");
        //触发执行
        env.execute("MEDICINE_DETAIL_024_Job");
    }
}
