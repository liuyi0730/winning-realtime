...
import com.winning.sink.MEDICINE_CATALOG_NUMBER_019_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_CATALOG_NUMBER_019_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_CATALOG_NUMBER")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_CATALOG_NUMBER_019_Sink()).name("Sink_019");
        //触发执行
        env.execute("MEDICINE_CATALOG_NUMBER_019_Job");
    }
}
