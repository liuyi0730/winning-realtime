...
import com.winning.sink.MEDICINE_DISTRIBUTED_HOSPITAL_036_Sink;
import com.winning.sink.MEDICINE_RESTRICTION_RULE_031_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_DISTRIBUTED_HOSPITAL_036_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_DISTRIBUTED_HOSPITAL")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_DISTRIBUTED_HOSPITAL_036_Sink()).name("Sink_036");
        //触发执行
        env.execute("MEDICINE_DISTRIBUTED_HOSPITAL_036_Job");
    }
}
