...
import com.winning.sink.LABTEST_SPECIMEN_058_Sink;
 ...
 * @Version 1.0
 */
public class LABTEST_SPECIMEN_058_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".LABTEST_SPECIMEN")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new LABTEST_SPECIMEN_058_Sink()).name("Sink_058");
        //触发执行
        env.execute("LABTEST_SPECIMEN_058_Job");
    }
}
