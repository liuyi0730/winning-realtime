...
import com.winning.sink.EXAMINATION_ITEM_CATEGORY_048_Sink;
 ...
 * @Version 1.0
 */
public class EXAMINATION_ITEM_CATEGORY_048_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".EXAMINATION_ITEM_CATEGORY")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new EXAMINATION_ITEM_CATEGORY_048_Sink()).name("Sink_048");
        //触发执行
        env.execute("EXAMINATION_ITEM_CATEGORY_048_Job");
    }
}
