...
import com.winning.sink.MEDICINE_HOSPITAL_SETTINGS_037_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_HOSPITAL_SETTINGS_037_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_HOSPITAL_SETTINGS")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_HOSPITAL_SETTINGS_037_Sink()).name("Sink_037");
        //触发执行
        env.execute("MEDICINE_HOSPITAL_SETTINGS_037_Job");
    }
}
