...
import com.winning.sink.MEDICINE_PACK_UNIT_USE_TYPE_018_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_PACK_UNIT_USE_TYPE_018_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_PACK_UNIT_USE_TYPE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_PACK_UNIT_USE_TYPE_018_Sink()).name("Sink_018");
        //触发执行
        env.execute("MEDICINE_PACK_UNIT_USE_TYPE_018_Job");
    }
}
