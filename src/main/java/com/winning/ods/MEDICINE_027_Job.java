...
import com.winning.sink.MEDICINE_027_Sink;
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_027_Sink()).name("Sink_027");
        //触发执行
        env.execute("MEDICINE_027_Job");
    }
}
