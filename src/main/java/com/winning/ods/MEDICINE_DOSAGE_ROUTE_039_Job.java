...
import com.winning.sink.MEDICINE_DOSAGE_ROUTE_039_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_DOSAGE_ROUTE_039_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_DOSAGE_ROUTE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_DOSAGE_ROUTE_039_Sink()).name("Sink_039");
        //触发执行
        env.execute("MEDICINE_DOSAGE_ROUTE_039_Job");
    }
}
