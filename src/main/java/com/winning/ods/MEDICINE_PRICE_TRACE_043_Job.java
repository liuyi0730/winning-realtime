...
import com.winning.sink.MEDICINE_PRICE_TRACE_043_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_PRICE_TRACE_043_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_PRICE_TRACE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_PRICE_TRACE_043_Sink()).name("Sink_043");
        //触发执行
        env.execute("MEDICINE_PRICE_TRACE_043_Job");
    }
}
