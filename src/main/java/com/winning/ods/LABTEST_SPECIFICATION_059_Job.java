...
import com.winning.sink.LABTEST_SPECIFICATION_059_Sink;
 ...
 * @Version 1.0
 */
public class LABTEST_SPECIFICATION_059_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".LABTEST_SPECIFICATION")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new LABTEST_SPECIFICATION_059_Sink()).name("Sink_059");
        //触发执行
        env.execute("LABTEST_SPECIFICATION_059_Job");
    }
}
