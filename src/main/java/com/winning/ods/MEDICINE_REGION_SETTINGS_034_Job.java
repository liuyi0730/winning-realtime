...
import com.winning.sink.MEDICINE_REGION_SETTINGS_034_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_REGION_SETTINGS_034_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_REGION_SETTINGS")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_REGION_SETTINGS_034_Sink()).name("Sink_034");
        //触发执行
        env.execute("MEDICINE_REGION_SETTINGS_034_Job");
    }
}
