 ...
 * @Version 1.0
 */
public class CLINICAL_SERVICE_TREATMENT_064_Sink extends TwoPhaseCommitSinkFunction<Tuple1<String>, HikariUtil, Void> { //表名替换
    private static final Logger log = LoggerFactory.getLogger(CLINICAL_SERVICE_TREATMENT_064_Sink.class);//表名替换

    public CLINICAL_SERVICE_TREATMENT_064_Sink() {//表名替换
    ...
    protected void invoke(HikariUtil HikariUtil, Tuple1<String> tuple, Context context) throws Exception {
        ...
        String upd_sql = "update clinical_service_treatment set end_time=? " +    //
        ...
        String insert_sql = "insert into clinical_service_treatment " +
                "(CS_ID,TREATMENT_TYPE_CODE,HOSPITAL_SOID,IS_DEL,CREATED_AT,MODIFIED_AT,TREATMENT_DURATION_CODE,start_time,physical_delete) " +
                "values (?,?,?,?,?,?,?,?,?)";//改为表的字段总数-1
        ...
        insert_ps.setString(2, jsonObject.getString("TREATMENT_TYPE_CODE"));
        ...
        insert_ps.setString(7, jsonObject.getString("TREATMENT_DURATION_CODE"));
