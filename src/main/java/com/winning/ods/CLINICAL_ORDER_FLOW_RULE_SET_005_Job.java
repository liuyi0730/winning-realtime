...
import com.winning.sink.CLINICAL_ORDER_FLOW_RULE_SET_005_Sink;
 ...
 * @Version 1.0
 */
public class CLINICAL_ORDER_FLOW_RULE_SET_005_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".CLINICAL_ORDER_FLOW_RULE_SET")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new CLINICAL_ORDER_FLOW_RULE_SET_005_Sink()).name("Sink_005");
        //触发执行
        env.execute("CLINICAL_ORDER_FLOW_RULE_SET_005_Job");
    }
}
