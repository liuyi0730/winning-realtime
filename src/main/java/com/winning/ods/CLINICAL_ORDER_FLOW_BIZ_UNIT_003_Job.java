...
import com.winning.sink.CLINICAL_ORDER_FLOW_BIZ_UNIT_003_Sink;
 ...
 * @Version 1.0
 */
public class CLINICAL_ORDER_FLOW_BIZ_UNIT_003_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".CLINICAL_ORDER_FLOW_BIZ_UNIT")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new CLINICAL_ORDER_FLOW_BIZ_UNIT_003_Sink()).name("Sink_003");
        //触发执行
        env.execute("CLINICAL_ORDER_FLOW_BIZ_UNIT_003_Job");
    }
}
