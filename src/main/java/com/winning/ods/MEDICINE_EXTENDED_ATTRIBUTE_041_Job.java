...
import com.winning.sink.MEDICINE_EXTENDED_ATTRIBUTE_041_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_EXTENDED_ATTRIBUTE_041_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_EXTENDED_ATTRIBUTE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_EXTENDED_ATTRIBUTE_041_Sink()).name("Sink_041");
        //触发执行
        env.execute("MEDICINE_EXTENDED_ATTRIBUTE_041_Job");
    }
}
