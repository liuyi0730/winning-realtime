...
import com.winning.sink.CLINICAL_FORM_EXT_DEF_DATA_052_Sink;
 ...
 * @Version 1.0
 */
public class CLINICAL_FORM_EXT_DEF_DATA_052_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".CLINICAL_FORM_EXT_DEF_DATA")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new CLINICAL_FORM_EXT_DEF_DATA_052_Sink()).name("Sink_052");
        //触发执行
        env.execute("CLINICAL_FORM_EXT_DEF_DATA_052_Job");
    }
}
