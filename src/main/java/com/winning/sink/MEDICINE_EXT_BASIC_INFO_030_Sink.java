 ...
 * @Version 1.0
 */
public class MEDICINE_EXT_BASIC_INFO_030_Sink extends TwoPhaseCommitSinkFunction<Tuple1<String>, HikariUtil, Void> { //表名替换
    private static final Logger log = LoggerFactory.getLogger(MEDICINE_EXT_BASIC_INFO_030_Sink.class);//表名替换

    public MEDICINE_EXT_BASIC_INFO_030_Sink() {//表名替换
    ...
    protected void invoke(HikariUtil HikariUtil, Tuple1<String> tuple, Context context) throws Exception {
        ...
        //主键设置，可能是多个字段组合成主键
		//------------begin---添加字段-----------
        String KeyID_01 = jsonObject.getString("MEDICINE_EXT_BASIC_INFO_ID"); //
        String KeyID_02 = jsonObject.getString("HOSPITAL_SOID"); //
        String upd_sql = "update medicine_ext_basic_info set end_time=? " +    //
                "where MEDICINE_EXT_BASIC_INFO_ID =? and HOSPITAL_SOID =? and end_time='3000-12-31 00:00:00' "; //
        ...
        String insert_sql = "insert into medicine_ext_basic_info " +
                "(MEDICINE_EXT_BASIC_INFO_ID,MEDICINE_ID,MEDICINE_NAME_IN_HOSPITAL,MEDICINE_SPEC_IN_HOSPITAL,BUSINESS_SCENARIO_CODE,SEQ_NO,IS_DEL,CREATED_AT,CREATED_BY,MODIFIED_BY,MODIFIED_AT,HOSPITAL_SOID,start_time,physical_delete) " +
                "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";//改为表的字段总数-1
        ...
        insert_ps.setString(3, jsonObject.getString("MEDICINE_NAME_IN_HOSPITAL"));
        insert_ps.setString(4, jsonObject.getString("MEDICINE_SPEC_IN_HOSPITAL"));
        insert_ps.setString(5, jsonObject.getString("BUSINESS_SCENARIO_CODE"));
        ...
        insert_ps.setString(9, jsonObject.getString("CREATED_BY"));
        insert_ps.setString(10, jsonObject.getString("MODIFIED_BY"));
