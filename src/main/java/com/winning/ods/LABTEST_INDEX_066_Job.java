...
import com.winning.sink.LABTEST_INDEX_066_Sink;
 ...
 * @Version 1.0
 */
public class LABTEST_INDEX_066_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".LABTEST_INDEX")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new LABTEST_INDEX_066_Sink()).name("Sink_066");
        //触发执行
        env.execute("LABTEST_INDEX_066_Job");
    }
}
