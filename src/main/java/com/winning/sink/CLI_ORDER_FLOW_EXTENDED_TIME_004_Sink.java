 ...
 * @Version 1.0
 */
public class CLI_ORDER_FLOW_EXTENDED_TIME_004_Sink extends TwoPhaseCommitSinkFunction<Tuple1<String>, HikariUtil, Void> {
    private static final Logger log = LoggerFactory.getLogger(CLI_ORDER_FLOW_EXTENDED_TIME_004_Sink.class);

    public CLI_ORDER_FLOW_EXTENDED_TIME_004_Sink() {
    ...
    protected void invoke(HikariUtil HikariUtil, Tuple1<String> tuple, Context context) throws Exception {
        ...
        //主键设置，可能是多个字段组合成主键
        String KeyID_01 = jsonObject.getString("COF_EXTENDED_TIME_ID");
        String KeyID_02 = jsonObject.getString("HOSPITAL_SOID");
        String upd_sql = "update cli_order_flow_extended_time set end_time=? " +
                "where COF_EXTENDED_TIME_ID =? and HOSPITAL_SOID =? and end_time='3000-12-31 00:00:00' ";
        ...
        String insert_sql = "insert into cli_order_flow_extended_time " +
                "(COF_EXTENDED_TIME_ID, SERVICE_START_AT, SERVICE_END_AT, SEQ_NO, IS_DEL," +
                " HOSPITAL_SOID, MODIFIED_AT, CREATED_AT, CLI_ORDER_FLOW_BU_ID,start_time,physical_delete) " +
                "values (?,?,?,?,?,?,?,?,?,?,?)";
        ...
        insert_ps.setTimestamp(2, jsonObject.getTimestamp("SERVICE_START_AT"));
        insert_ps.setTimestamp(3, jsonObject.getTimestamp("SERVICE_END_AT"));
        ...
        insert_ps.setString(9, jsonObject.getString("CLI_ORDER_FLOW_BU_ID"));
        insert_ps.setTimestamp(10, new Timestamp(jsonObject.getTimestamp("binlog_start_time").getTime()));
