 ...
 * @Version 1.0
 */
public class MEDICINE_RECOMMENDED_DOSAGE_040_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_RECOMMENDED_DOSAGE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_RECOMMENDED_DOSAGE_040_Sink()).name("Sink_040");
        //触发执行
        env.execute("MEDICINE_RECOMMENDED_DOSAGE_040_Job");
    }
}
