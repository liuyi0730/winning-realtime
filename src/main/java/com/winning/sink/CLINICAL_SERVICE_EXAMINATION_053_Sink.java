 ...
 * @Version 1.0
 */
public class CLINICAL_SERVICE_EXAMINATION_053_Sink extends TwoPhaseCommitSinkFunction<Tuple1<String>, HikariUtil, Void> { //表名替换
    private static final Logger log = LoggerFactory.getLogger(CLINICAL_SERVICE_EXAMINATION_053_Sink.class);//表名替换

    public CLINICAL_SERVICE_EXAMINATION_053_Sink() {//表名替换
    ...
    protected void invoke(HikariUtil HikariUtil, Tuple1<String> tuple, Context context) throws Exception {
        ...
        String upd_sql = "update clinical_service_examination set end_time=? " +    //
        ...
        String insert_sql = "insert into clinical_service_examination " +
                "(CS_ID,EXAM_TYPE_CODE,EXAM_BEDSIDED_ALLOWED_FLAG,MODIFY_FREQ_ALLOWED_FLAG,MULTI_PART_SELECT_ALLOWED_FLAG,HOSPITAL_SOID,IS_DEL,CREATED_AT,MODIFIED_AT,BODY_SITE_CODE,CONTRAST_AGENT_ALLOWED_FLAG,STORAGE_MEDIA_ALLOWED_FLAG,CLI_ORDER_SPLIT_TYPE_CODE,BODY_SIDE_CODE,start_time,physical_delete) " +
                "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";//改为表的字段总数-1
        ...
        insert_ps.setString(2, jsonObject.getString("EXAM_TYPE_CODE"));
        insert_ps.setString(3, jsonObject.getString("EXAM_BEDSIDED_ALLOWED_FLAG"));
        insert_ps.setString(4, jsonObject.getString("MODIFY_FREQ_ALLOWED_FLAG"));
        insert_ps.setString(5, jsonObject.getString("MULTI_PART_SELECT_ALLOWED_FLAG"));
        ...
        insert_ps.setString(10, jsonObject.getString("BODY_SITE_CODE"));
        insert_ps.setString(11, jsonObject.getString("CONTRAST_AGENT_ALLOWED_FLAG"));
        insert_ps.setString(12, jsonObject.getString("STORAGE_MEDIA_ALLOWED_FLAG"));
        insert_ps.setString(13, jsonObject.getString("CLI_ORDER_SPLIT_TYPE_CODE"));
        insert_ps.setString(14, jsonObject.getString("BODY_SIDE_CODE"));
