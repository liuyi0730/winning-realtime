...
import com.winning.sink.CLI_ORDER_FLOW_RULE_GROUP_DETAIL_006_Sink;
 ...
 * @Version 1.0
 */
public class CLI_ORDER_FLOW_RULE_GROUP_DETAIL_006_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".CLI_ORDER_FLOW_RULE_GROUP_DETAIL")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new CLI_ORDER_FLOW_RULE_GROUP_DETAIL_006_Sink()).name("Sink_006");
        //触发执行
        env.execute("CLI_ORDER_FLOW_RULE_GROUP_DETAIL_006_Job");
    }
}
