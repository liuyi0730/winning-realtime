...
import com.winning.sink.LINKAGE_TARGET_CS_DETAIL_014_Sink;
 ...
 * @Version 1.0
 */
public class LINKAGE_TARGET_CS_DETAIL_014_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".LINKAGE_TARGET_CS_DETAIL")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new LINKAGE_TARGET_CS_DETAIL_014_Sink()).name("Sink_014");
        //触发执行
        env.execute("LINKAGE_TARGET_CS_DETAIL_014_Job");
    }
}
