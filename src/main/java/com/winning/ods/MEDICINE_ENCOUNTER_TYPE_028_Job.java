...
import com.winning.sink.MEDICINE_ENCOUNTER_TYPE_028_Sink;
 ...
 * @Version 1.0
 */
public class MEDICINE_ENCOUNTER_TYPE_028_Job {
...
//        env.setStateBackend(new FsStateBackend(statebackend_address));
        ...
        DebeziumSourceFunction<String> sourceFunction = MySqlSource.<String>builder()
                ...
                .tableList(parameterTool.get("databaseList") + ".MEDICINE_ENCOUNTER_TYPE")
        ...
        //数据传输到下游
        DSS_orders3.addSink(new MEDICINE_ENCOUNTER_TYPE_028_Sink()).name("Sink_028");
        //触发执行
        env.execute("MEDICINE_ENCOUNTER_TYPE_028_Job");
    }
}
